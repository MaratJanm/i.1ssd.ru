...
class Temperature(db.Model):
    ...
    parameter_241 = db.Column(db.String(50), nullable=True)
    parameter_243 = db.Column(db.String(50), nullable=True)
    parameter_228 = db.Column(db.String(50), nullable=True)
    parameter_005 = db.Column(db.String(50), nullable=True)
    parameter_009 = db.Column(db.String(50), nullable=True)
    parameter_170 = db.Column(db.String(50), nullable=True)
    parameter_174 = db.Column(db.String(50), nullable=True)
    parameter_184 = db.Column(db.String(50), nullable=True)
    parameter_187 = db.Column(db.String(50), nullable=True)
    parameter_194 = db.Column(db.String(50), nullable=True)
    parameter_192 = db.Column(db.String(50), nullable=True)
    parameter_199 = db.Column(db.String(50), nullable=True)
    parameter_197 = db.Column(db.String(50), nullable=True)
